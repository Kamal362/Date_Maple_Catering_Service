...
const OrderTracking: React.FC = () => {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-cream to-light-tea flex items-center justify-center">
  ...
  if (selectedOrder) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-cream to-light-tea">
