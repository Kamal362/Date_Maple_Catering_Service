...
const AdminNavbar: React.FC = () => {
  ...
  const navLinks = [
    ...
    { to: '/orders', label: 'Orders', icon: 'M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z' },
  ...
  const contentLinks = [
    ...
    { to: '/home-content', label: 'Homepage' },
          ...
          <div className="hidden lg:flex items-center space-x-1">
            ...
            <div className="relative" ref={contentRef}>
              <button
                ...
                className={`flex items-center px-3 py-2 rounded-md text-sm font-medium transition-colors duration-200 ${
                  isActive('/users') || isActive('/home-content') || isActive('/reviews')
                    ? 'bg-primary-tea text-white'
                    : 'text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 hover:text-primary-tea dark:hover:text-primary-tea'
                }`}
              >
                ...
                Content
                <svg className={`w-4 h-4 ml-1 transition-transform ${contentDropdownOpen ? 'rotate-180' : ''}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
                </svg>
              </button>
