                ...
                <div className="p-6">
                  ...
                  <div className="space-y-6">
                    {cartItems.map((item, index) => {
                      ...
                      return (
                        <div key={itemKey} className="flex items-center border-b border-secondary-tea pb-6 last:border-b-0">
                          ...
                          <div className="ml-4 flex-grow">
                            ...
                            {item.customization && (
                              <div className="text-sm text-secondary-tea mt-1 space-y-0.5">
                            ...
                            <p className="text-secondary-tea text-sm mt-1 line-clamp-2">{item.description}</p>
              ...
              <div className="bg-white rounded-lg shadow-md p-6 sticky top-6">
                ...
                <div className="space-y-4 mb-6">
                  ...
                  {taxSettings.taxEnabled && (
                    <div className="flex justify-between">
                      <span className="text-secondary-tea">{taxSettings.taxLabel} ({taxSettings.taxRate}%)</span>
