      ...
      <div className="container mx-auto px-4">
        <div className="flex justify-between items-center h-20">
          ...
          <div className="hidden md:flex items-center space-x-6">
            ...
            <Link to="/events" className="text-dark-tea hover:text-primary-tea transition-colors duration-300 font-medium relative group flex items-center">
              <svg className="w-5 h-5 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <Link to="/profile" className="text-dark-tea hover:text-primary-tea transition-colors duration-300 font-medium relative group flex items-center">
              <svg className="w-5 h-5 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        {isOpen && (
          <div className="md:hidden pb-4">
            ...
            <Link to="/events" className="flex items-center py-2 text-dark-tea hover:text-primary-tea transition-colors duration-300 font-medium" onClick={() => setIsOpen(false)}>
              <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"></path>
              </svg>
              Events
            ...
            <Link to="/profile" className="flex items-center py-2 text-dark-tea hover:text-primary-tea transition-colors duration-300 font-medium" onClick={() => setIsOpen(false)}>
              <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path>
              </svg>
              My Account
